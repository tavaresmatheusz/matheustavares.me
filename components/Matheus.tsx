...
const Matheus = (): JSX.Element => {
    return (
    <div className="bg-[#1A1A1A] h-[463px] flex justify-center">
        <div className="bg-[#D9D9D9] flex justify-center w-[783px] h-[388px] items-center rounded-[30px] mt-[30px]">
            <div className="w-[580px] h-[253px] flex justify-center flex-row items-center gap-x-[50px]">
